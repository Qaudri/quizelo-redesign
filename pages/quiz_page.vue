  ...
  <div class="flex justify-center h-screen">      
    <div class="w-full my-20">
      <div class=""> 
        ...
        <div class="container mx-auto relative flex h-fit justify-center items-center mb-10 w-full">
          <SectionsQuizHeader class="w-full flex justify-between absolute" @ModalDialog="openDialog" />
        </div>
